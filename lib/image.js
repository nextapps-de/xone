...
APP.PLUGIN.Image = (function(){
    ...
    var use_filesystem = !!window['requestFileSystem'];
    var use_image_cache = !use_filesystem;
    var image_cache = {};
                            ...
                            if(use_image_cache && image_cache[file_id]){
                                ...
                                if(use_filesystem){
                                    ...
                                    //APP.VARS.fs.exist(cache_id, function(exist){
                                        ...
                                        //if(exist){
                                        if(cache_id.indexOf('filesystem:') === 0){
                    ...
                    if(use_filesystem) {
                        ...
                        //APP.VARS.fs.exist(current_image, function(exist){
                            ...
                            //if(exist) {
                                ...
                                APP.VARS.fs.delete(current_image);
                           // }
                        //});
                    }
                    else{

                        if(use_image_cache) delete image_cache[current_image];

                        window.localStorage.removeItem(current_image + ".base64");
                    }
                ...
                CORE.queue(function(){
                    ...
                    if(use_filesystem){
                        ...
                        CORE.stack(function(){
                            ...
                            data = APP.STORAGE.compress(data);
