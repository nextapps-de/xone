...
//if(ENV !== 'production'){
    ...
    /**
     * ASAP v1.03 - Asynchronous Javascript
    ...
    var AMD = (function(){
        ...
        var build = function(namespace, _convert){
            ...
            for(var k = 0; k < require_order.length; k++){
                ...
                if(sources.hasOwnProperty(key) || CORE.contains(key, '$$require$$')){
                    ...
                    if(namespace && !CORE.contains(key, '$$require$$') && !CORE.contains(key, namespace + '.')){
                    ...
                    while(i < len){
                        ...
                        if(isType(imported[str], 'undefined')){
                            ...
                            if(isType(build_check[str], 'undefined')){
                                ...
                                js[js.length] = (CORE.contains(str, '.') || isPublic2 ? '' : 'var ') + str_final + ' = {};';
        ...
        var updateCache = function(){
            ...
            while(a < cache.length){
                ...
                if(state){
                    ...
                    if(DEBUG) console.log("UPDATE: " + namespace);
         ...
         * @const
         */
        var addCache = function(namespace, dependencies, fn, self){
                            ...
                            if(sources.hasOwnProperty(key)){
                                ...
                                if(isType(sources[key][0], 'string')){
                                    ...
                                    if(namespace === sources[key][0]){
                                        ...
                                        if(DEBUG) console.log("update addon 1: " + key);
                                    ...
                                    //if(!sources[key][0]) sources[key][0] = [sources[key][0]];
                                    ...
                                    for(var i = 0; i < len; i++){
                                        ...
                                        if(isType(sources[key][0][i], 'string')){
                                            ...
                                            if(namespace === sources[key][0][i]){
                                                ...
                                                if(DEBUG) console.log("update addon 2: " + key);
            ...
            /* CHECK VALUE: DIRECT ASSIGN, NO DEPENDENCIES */
                ...
                while(i < len){
                    ...
                    if(isType(module, 'undefined')){
                        ...
                        if(DEBUG) console.warn('Missing: ' + namespace + ' => ' + dependencies[i]);
            ...
            while(i < len){
                ...
                if(isType(dependencies[i], 'string')){
                    ...
                    if(isType(sources[dependencies[i]], 'undefined')){
                        ...
                        if(DEBUG) console.warn('Build Missing: ' + dependencies[i]);
                        return;
                    }
        ...
        var buildStart = function(dependencies){
            ...
            if(dependencies){
                ...
                if(DEBUG) console.log(publicList);
            }
            //imported = {};
        };
