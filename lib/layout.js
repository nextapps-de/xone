...
(function(LAYOUT, CONTROLLER, STORAGE, EVENT){
    ...
    LAYOUT.show_popup = function(_wrapper, preloader_target, hideStatusbar){
        ...
        if(!CORE.isType(hideStatusbar)) hideStatusbar = !CORE.hasClass(CORE.getByTag('header', wrapper)[0] || wrapper, 'status-bar');
    ...
    LAYOUT.hide_popup = function(_wrapper, _showStatusbar){
        ...
        CORE.paint(function(){
            ...
            if(!CORE.isType(showStatusbar)) showStatusbar = !CORE.hasClass(CORE.getByTag('header', wrapper)[0] || wrapper, 'status-bar');
