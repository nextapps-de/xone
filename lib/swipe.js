...
(function(){
    ...
    (APP.EVENT['_document'] || (APP.EVENT['_document'] = [])).push({
        ...
        do: function(e){
            ...
            dom_view = CORE.getById(APP.VIEW.last_view() || APP.VIEW.current_view());
            ...
            // TODO: WTF???
            //CORE.removeClass(dom_view, 'reveal');
        },
        stopBubble: false,
        ...
        if(distX !== 0){
            ...
            if(distX > (width / 100 * 38.2)){
                ...
                CORE.paint(function(){
                    ...
                    CORE.animate('#' + APP.VIEW.current_view(), {

                        'transform': 'translate(100%, 0) !important'
                    });

                    CORE.animate(CORE.getByTag('xone-header', APP.VIEW.current_view())[0], {

                        'opacity': 0,
                        'transform': 'translate(-50%, 0) !important'
                    });

                    CORE.animate(CORE.getByTag('xone-shadow', APP.VIEW.current_view())[0], {

                        'transform': 'translate(0, 0) !important'
                    });

                    CORE.animate(CORE.getByTag('xone-header', APP.VIEW.last_view())[0], {

                        'opacity': 1,
                        'transform': 'translate(0, 0) !important'
                    });

                    CORE.animate(CORE.getByTag('xone-tabbar')[0], {
