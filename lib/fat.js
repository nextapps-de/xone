     ...
     */
     ...
     function FAT_handleJob(obj, style, to, /*start,*/ duration, easeStr, callback, step){
        ...
        if(cur_job) {
            ...
            //console.log(from);
            //console.log(to);
            cur_job.duration = duration || (duration = 350);
...
*/
            ...
            FAT_ANISTACK[FAT_ANISTACK.length] = obj[checkkey] = /** @type {_fatjob_interface} */ (new FATJOB(
    ...
    CORE.animate = function FAT_animate(
