...
(function() {
    ...
    var requestFrame = (
        ...
        window[CORE.prefix.lowercase + 'RequestAnimationFrame'] ||
        function(fn){
    ...
    var clearFrame = (
        ...
        window[CORE.prefix.lowercase + 'CancelAnimationFrame'] ||
        function(id){
			...
			if(CORE.isType(val)){
			    ...
			    if(auto_prefix_styles){
                    ...
                    if((css === 'transition') || (css === 'transform')){
                        ...
                        if((css === 'transition') && ('' + val).indexOf('transform') !== -1){
                    ...
                    if(css.hasOwnProperty(css_key)){
                        ...
                        if(auto_prefix_styles){
                            ...
                            if((css_key === 'transition') || (css_key === 'transform')){
                                ...
                                if((css_key === 'transition') && css[css_key].indexOf('transform') !== -1){
                ...
                return (
                    ...
                    index = PROC_TIMER[PROC_TIMER.length] = /** @type {number} */ (
                        ...
                        CORE.async(function(){
                            ...
                            var i = index > 0 ? PROC_TIMER.indexOf(index) : index;
    ...
    CORE.clear = CORE.clearAll = function clear(id){
        ...
        else if(PROC_TIMER.length){

            for(var i = 0; i < PROC_TIMER.length; i++){

                window.clearTimeout(PROC_TIMER[i]);
                clearFrame.call(window, PROC_TIMER[i]);
            }
