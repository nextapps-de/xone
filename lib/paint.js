...
(function() {
    ...
    var initial_force_sync = false;

    /**
     * @type {boolean}
     */

    var force_sync = initial_force_sync;
    ...
    function processPaint(time) {
        ...
        // Styles may override Class definitions, so apply it afterwards
