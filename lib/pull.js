...
APP.VIEW.PULL = (function(){
    ...
    function pull_touchstart_handler(event){
        ...
        if(!loading_timer && (this.scrollTop === 0)
            ...
            if(pull_element){
                ...
                // attach handlers
                section_element.ontouchmove = pull_touchmove_handler;
                section_element.ontouchend = pull_touchend_handler;
            }
        }
    }
    ...
    function pull_touchmove_handler(event){
        ...
        if(scroll_pos > 0){
            ...
            section_element.ontouchmove = null;
            section_element.ontouchend = null;
