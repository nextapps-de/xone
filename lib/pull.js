...
APP.VIEW.PULL = (function(){
    ...
    function pull_touchstart_handler(event){
        ...
        if(!loading_timer && (this.scrollTop === 0)
            ...
            if(pull_element){
                ...
                // CORE.getClosest(this, 'xone-section').style['webkitOverflowScrolling'] = 'auto !important';
                // CORE.getClosest(this, 'xone-section').style['overflowScrolling'] = 'auto !important';
                // CORE.getClosest(this, 'xone-section').style['overflow'] = 'hidden !important';
                //
                // console.log(CORE.getClosest(this, 'xone-section'));

                // var scroll_element = this;
                //
                // while(scroll_element && (scroll_element !== document.body)){
                //
                //     if(scroll_element.scrollTop === 0){
                //
        ...
        CORE.setStyle(section_element, 'will-change', 'transform');
        CORE.setStyle(pull_element, 'will-change', 'transform, opacity');
    }
    ...
    function stopPull(){
        ...
        //CORE.getPrevious(section_element, 'xone-section').style['-webkit-overflow-scrolling'] = 'touch';

        CORE.setStyle(section_element, {
