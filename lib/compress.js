...
(function(){
    ...
    if(DEBUG) {
        ...
        Console.log('Initialize Compression');
    }
    ...
    var registerCompressor = function(compressor){
        ...
        if(DEBUG) {
            ...
            Console.log('Current Compression Level: ' + compressor.info);
        }
        ...
        APP.STORAGE.compress = function(data, callback){
            ...
            if(callback && APP.WORKER['compress']){
                ...
                if(DEBUG){
                    ...
                    Console.log("Worker Job Called: " + id);
                }
    ...
    var determineLevel = function(){
        ...
        if(DEBUG && !APP.CONFIG.GZIP) {
            ...
            Console.log('Current Compression Level: -');
        }
